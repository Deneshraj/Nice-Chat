        ...
        <div class="ksdjbj">
            <div class="kdb">
                <div class="sfejn">
                    ...
                    <a href="profile.php?id=<?php echo $logged_in_user_obj->getId();?>" class="kesjw"><?php echo $logged_in_user_obj->getUserName() ?></a>
                </div>
                <div class="mndksj">
                    <div class="wcielk">
                        <a class="ksjdf sldf" href="subpages.php?source=group&task=create_group"><i class="fas fa-plus"></i>Create New Group</a>
                    </div>
                    <div class="wcielk">
                        <a class="ksjdf" href="subpages.php?source=group&task=view_users_group"><i class="fas fa-plus"></i>Your Group</a>
                    </div>
                </div>
            </div>
        </div>
